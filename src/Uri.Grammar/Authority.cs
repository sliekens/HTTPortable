namespace Uri.Grammar
{
    ...
    public class Authority : Element
    {
        ...
        public Authority(UserInformation userInformation, Element userInformationSeparator, Host host, Element portSeparator, Port port, ITextContext context)
            : base(string.Concat(userInformation, userInformationSeparator, host, portSeparator, port), context)
        {
            this.userInformation = userInformation;
            this.host = host;
            this.port = port;
            Contract.Requires(userInformation == null || (userInformationSeparator != null && userInformationSeparator.Data == "@"));
