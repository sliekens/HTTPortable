namespace Uri.Grammar
{
    ...
    public class PathCharacterLexerTests
    {
        ...
        public void Read_ShouldSucceed(string input)
        {
            ...
            var factory = new PathCharacterLexerFactory(unreservedLexerFactory, percentEncodingLexerFactory, subcomponentsDelimiterLexerFactory, caseInsensitiveTerminalLexerFactory, alternativeLexerFactory);
